...
export default function AssignmentEditor() {
  ...
  return (
    <div id="wd-assignments-editor">
      ...
      <input id="wd-name" className="form-control mb-3" value={assignmentTitle} onChange={(e) => setAssignmentTitle(e.target.value)} />
      <textarea className="form-control mb-3" id="wd-description" value={assignmentDescription} onChange={(e) => setAssignmentDescription(e.target.value)} />  
      <div className="col">
        <div className="row">
          <div className="col">
          ...
          <div className="col-8 mb-3">
            <input className="form-control" id="wd-points" value={assignmentPoints} onChange={(e) => setAssignmentPoints(e.target.value)}/>
          </div>
        </div>
            ...
            <div className="forms">
              ...
              <div className="row">
                <div className="col text-left">
                  ...
                  <input className="form-control" type="datetime-local" id="wd-available-from" defaultValue={assignmentAvailableFromDate} onChange={(e) => setAssignmentAvailableFromDate(e.target.value)} />
                </div>
                <div className="col text-right"> 
                  <label className="form-label" htmlFor="wd-available-until"><b>Until</b></label>
                  <input className="form-control" type="datetime-local" id="wd-available-until" defaultValue={assignmentAvailableUntilDate} onChange={(e) => setAssignmentAvailableUntilDate(e.target.value)}/>
                </div>
              </div>
            </div>
          </div>  
        ...
        <div className="mt-3">
          <div className="row float-end">
            <div className="col">
              ...
              <button onClick={handleSave} id="wd-add-assignment" className="btn btn-danger btn-lg">
                Save
              </button>
            </div>
          </div>
